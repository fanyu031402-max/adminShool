    ...
    <div class="wrapper">
      <div class="content">
        ...
        <div class="animation-window">
          <canvas id="animationCanvas" ref="animationCanvas" width="53" height="26"></canvas>
        </div>
...
export default {
  ...
  methods: {
    ...
    startAnimation() {
      ...
      if (!this.animationId) {
        this.$nextTick(() => this.draw()); // 等待canvas渲染后开始动画
      }
